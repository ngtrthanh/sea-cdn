                ...
                if (lat !== null && lon !== null) {
                    if (MMSI >= 201000000 && MMSI <= 775999999) {
                        ...
                        if (heading === null) {
                            ...
                            // tooltipContent = `<span class="fi fi-${country.toLowerCase()}"></span> <b>MMSI: ${MMSI}</b> Heading: ${heading}° Ship type: getShipTypeVal(${shiptype}) Speed: ${speed} `;
                            ...
                            tooltipContent = `
                                ...
                                <b>MMSI: ${MMSI}</b>, Hdng: ${heading}°, Type: ${getShipTypeVal(shiptype)}, Spd: ${speed}
                                `;
                    ...
                    var tooltip = marker.bindTooltip(tooltipContent, {
