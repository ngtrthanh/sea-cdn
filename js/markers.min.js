...
let shapes = {
    ...
    c130: {
        ...
        strokeScale: 2,
        viewBox: "-1 -16 64 64",
        path: "m36.3839 9.4967c-.218.0755-.2988.1672-.4739.3428-.2456.4806-.388 1.2731-.5349 1.8758-.0185.0394-.0341.0704-.054.1135-.2441.2743-.4446.5806-.6117.9096-.0869.1477-.1497.3099-.2084.475-.0419.1067-.0799.2156-.1163.3258-.0379.1005-.079.1995-.1282.2942l.0318.0085c-.2247.7971-.3316 1.6642-.3997 2.5258l-.0181 6.9881-.0569.0015.0256-2.4094c-.3243.0998-.6384.6561-.6265 1.3602v1.0657l-3.9255.0812c-.0754-1.5294-.2249-3.6748-.7617-3.6928-.5789.0332-.6816 2.2178-.6818 3.7226l-2.533.0522c-.0966-.6696-.2581-1.276-.5163-1.7646h-.1722c-.2582.4896-.4151 1.1055-.5049 1.7892l-1.6069.0331c-.0724-1.5336-.2148-3.8604-.7725-3.8791-.6014.0343-.6919 2.4066-.6841 3.909l-9.4962.196c-1.3201.1305-.2852 3.7984.014 3.5052l12.7641 1.6635c.125.9046.2635 1.7475.3728 2.4351.1206-.6491.2653-1.4576.3938-2.3353l3.8973.5081 4.1503-.0558.702 1.1332-.0191 7.3803c.1025.4632.525.5023.2244 1.4996l-7.8518 1.3923v.6673l-.0248.0005.0248.007v1.1992l8.4127 1.2317c1.0406-.0245 1.3133 1.0871 1.9629 1.0174v-.0127c.6307.0371.9109-1.04 1.9371-1.0158l8.4127-1.2294v-1.2059l.0437-.0124-.0437-.0008v-.6521l-7.8518-1.39c-.3006-.9955.122-1.0343.2244-1.4968l-.0189-7.2862.8504-1.2224 4.15.0561 3.8074-.4962c.1175.8276.245 1.6003.3462 2.2365.1205-.6485.2648-1.4562.3933-2.3329l12.8812-1.6791c.2993.2933 1.334-3.3748.014-3.5052l-8.7896-.1812c.0304-.0194.0603-.0408.0926-.053-.0721-1.5329-.2131-3.8919-.7744-3.9108-.6048.0346-.6938 2.4347-.6849 3.9356l-2.5146-.052c-.094-.7132-.2592-1.3585-.5313-1.8734h-.1722c-.2657.5038-.4244 1.1406-.5127 1.8484l-1.5996-.0331c-.0727-1.5336-.2155-3.8532-.7723-3.872-.5934.034-.6881 2.3371-.6831 3.842l-4.818-.0993-.0421-.0026v-1.0632c.012-.7042-.3021-1.2607-.6265-1.3604l.0256 2.3864-.0584-.0036-.0176-6.8679-.0003-.0605c-.0706-.8912-.1765-1.7605-.4103-2.5547l.0396-.0106c-.2257-.4339-.2839-.9552-.6159-1.3178l-.0023.0008c-.1219-.1941-.2576-.3801-.4132-.5546-.0442-.1394-.0656-.2337-.0913-.3356-.0256-.2764-.0527-.5481-.1567-.8917-.0802-.2051-.1163-.3953-.1965-.5846-.1255-.2258-.1375-.2635-.2772-.4214-.2002-.151-.2098-.1678-.4742-.2332z"
    },
    hi_perf: {
        id: 7,
        w: 32,
    ...
    gyrocopter: {
        ...
        h: 27,
        strokeScale: 1,
        path: ["M12.13 18.58l-.27-.43-.66.81-2.51.23s-.07 1.23-.24.03c0 0-.13-1-.1-1.97 0 0 .23-.33.33-.11v.16l3.3-1.9s-.15-.29-.24-.64c0 0-1.56.02-2.53-.14v-.13s1.35-.02 2.47-.1l.41-.04v-.12h-1.24s-.1.05-.1-.11v-.2s-.28.07-.27-.19V12.7l-1.73-.26s.05.49-.28.48c0 0-.25 0-.26-.24v-.92s.02-.25.25-.26c0 0 .25 0 .26.24v.36h.1l1.93.1v-.11c.05-.5.03-.97.03-.97s-.14-1.68.02-3.11c0 0 .39-3.42 1.44-4.1 1.04.68 1.43 4.1 1.43 4.1.16 1.43.02 3.11.02 3.11s-.02.47.03.97v.11l1.93-.1h.1v-.36c.01-.25.26-.24.26-.24.23.01.25.26.25.26v.92c-.01.24-.25.24-.25.24-.34 0-.28-.48-.28-.48l-1.74.26v1.03c.01.26-.26.18-.26.18v.2c0 .17-.1.12-.1.12h-1.25v.12l.42.04c1.11.08 2.47.1 2.47.1v.13c-.98.16-2.54.14-2.54.14-.08.35-.24.63-.24.63l3.3 1.9v-.15c.1-.22.33.11.33.11.04.98-.1 1.97-.1 1.97-.17 1.2-.24-.03-.24-.03l-2.51-.23-.65-.8-.28.42-.1 1.57z", "M25.68 21.87l-12.47-7.8-.37-.76-.42-.26s-.54.3-.6-.35l-.3-.23s-.13.04-.5-.21l-12.7-7.94s.06-.52.45-.7l12.41 7.77.42.76.38.24s.6-.26.64.4l.33.21s.32.09.56.27l12.61 7.89s.02.43-.44.7z"]
    },
    helicopter: {
        id: 46,
        w: 29,
    ...
    chinook: {
        ...
        w: 32,
        h: 32,
        path: ["M9.9 8.23s-.08-3.57 1.17-3.46c0 0 1-.12 1.2.5 0 0 .4.83.47 2.9m0 0s.56.08.53.85l-.01 8.41s-.02.34-.23.44c0 0 .06.26-.16.48l.03.22h-.19s.06 2.07-1.12 2.06c0 0-.73.12-1.06-.24 0 0-.65-.65-.58-1.81h-.18l.07-.26s-.19-.12-.14-.4c0 0-.23-.02-.28-.45v-8.7s.07-.52.49-.54", "M17.76 13.38l-.58.56-4.63-5.05-.12-.84-.48-.62h-.16l-.2-.24s-.54.27-.76-.35l-.34.04-1.07.38-6.98 1.53-.15-.74L8.9 6.6l.8.24.74-.07.12-.14.23-.03s.1-.65.75-.51l.3-1.33L13.99-2l.7.21-2.01 6.48-.66.53-.26.64.09.15-.13.25s.4.36.06.76l.3.35.92.86z", "M20.33 16.18l.2.78-6.69 1.52-.79-.31-.77.12-.08.13-.3.06s-.04.6-.69.48l-.13.32-.2 1.12-2.12 6.82-.72-.24 2-6.46.61-.56.3-.68-.06-.18.09-.2s-.51-.41-.07-.91l-1.02-.92-4.8-5.22.53-.5 4.63 4.94.14.84.43.54H11l.15.24s.51-.17.7.32l.45-.09 1.2-.38z"]
    },
    apache: {
        id: 51,
        w: 31,
...
{
    let l = Object.entries(shapes);
    for (let e in l) {
        let c = l[e][0];
        l[e][1].name = c
    }
}
const _ulac = ["cessna", .92];
let TypeDesignatorIcons = {
    ...
    PRM1: ["jet_nonswept", .96],
    E55P: ["jet_nonswept", .96],
    E50P: ["jet_nonswept", .96],
    EA50: ["jet_nonswept", .96],
    HDJT: ["jet_nonswept", .96],
    SF50: ["jet_nonswept", .94],
    C97: ["super_guppy", 1],
    SGUP: ["super_guppy", 1],
    A3ST: ["beluga", 1],
    A337: ["beluga", 1.06],
...
function getBaseMarker(l, e, c, s, t, h, a) {
    if (e in TypeDesignatorIcons) {
        return [TypeDesignatorIcons[e][0], TypeDesignatorIcons[e][1]]
    }
    if (null != c && 3 === c.length) {
        ...
        if (null !== s && 1 === s.length) {
            ...
            if ("L2J-M" === e && "A2" === l)
                return ["jet_swept", 1];
            if (e in TypeDescriptionIcons) {
                return [TypeDescriptionIcons[e][0], TypeDescriptionIcons[e][1]]
            }
        }
        if (c in TypeDescriptionIcons) {
            return [TypeDescriptionIcons[c][0], TypeDescriptionIcons[c][1]]
        }
        let e = c.charAt(0);
        if (e in TypeDescriptionIcons)
            return [TypeDescriptionIcons[e][0], 1]
    }
    return l in CategoryIcons ? CategoryIcons[l] : "ground" != h || "adsb_icao_nt" != t && "tisb_other" != t && "tisb_trackfile" != t ? ["unknown", 1] : ["ground_square", 1]
}
function svgShapeToSVG(l, e, c, s, t) {
    if (!l)
        return console.error("Shape object is undefined or null."),
        "unknown";
    if (t = t || 1,
    !l.w || !l.h)
        return console.error("Required properties of shape are undefined."),
        "";
    s *= l.strokeScale ? l.strokeScale : 1;
    let h = l.w * t
      , a = l.h * t;
    if (!l.path) {
        let t = l.svg.replace("fillColor", e).replace("strokeColor", c).replace("strokeWidth", s);
        return t = t.replace("SIZE", 'width="' + h + 'px" height="' + a + 'px"'),
        t
    }
    let i = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="' + l.viewBox + '" ' + (l.noAspect ? 'preserveAspectRatio="none" ' : "") + 'width="' + h + '" height="' + a + '"><g' + (l.transform ? ' transform="' + l.transform + '"' : "") + ">"
      , v = l.path;
    Array.isArray(v) || (v = [v]);
    for (let l = 0; l < v.length; l++)
        i += '<path paint-order="stroke" fill="' + e + '" stroke="' + c + '" stroke-width="' + 2 * s + '" d="' + v[l] + '"/>';
    let r = .6 * (l.accentMult ? l.accentMult * s : s)
      , o = l.accent;
    Array.isArray(o) || (o = [o]);
    for (let l = 0; l < o.length; l++)
        i += '<path fill="none" stroke="' + c + '" stroke-width="' + r + '" d="' + o[l] + '"/>';
    return i += "</g></svg>",
    i
}
function svgShapeToURI(l, e, c, s, t) {
    let h = svgShapeToSVG(l, e, c, s, t);
...
function getSpriteX(l) {
    return l.id % glImapWidth
}
function getSpriteY(l) {
    return Math.floor(l.id / glImapWidth)
}
function iconTest_0() {
    ...
    let l = document.getElementById("iconTestCanvas");
    console.log(l);
    let e = new URLSearchParams(window.location.search)
      , c = glIconSize
      , s = glImapWidth
      , t = glImapHeight;
    l.innerHTML = '<div style="overflow: scroll; max-height: 100%; max-width: 100%"><canvas width="' + c * s + '" height="' + c * t + '" id="can"></canvas></div>';
    let h = document.getElementById("can")
      , a = h.getContext("2d")
      , i = {};
    for (let s in shapes) {
        let h = shapes[s];
        ...
        let v = c / Math.max(h.w, h.h)
          , r = v * Math.abs(h.w - h.h)
          , o = 0
          , n = 0;
        h.w >= h.h ? n = r / 2 : o = r / 2;
        let p = document.createElement("img");
        p.onload = function() {
            a.drawImage(this, getSpriteX(h) * glIconSize + o, getSpriteY(h) * glIconSize + n)
        }
        ;
        let w = svgShapeToURI(h, "#FFFFFF", "#000000", .375, v);
        p.src = w;
        let L = svgShapeToSVG(h, "#FFFFFF", "#000000", .375, 1.4);
        if (i[s] = L,
        e.has("grid")) {
            let l = document.createElement("img");
            l.onload = function() {
                a.drawImage(this, getSpriteX(h) * glIconSize, getSpriteY(h) * glIconSize)
            }
            ;
            let e = svgShapeToURI(refCross, "#FFFFFF", "#000000", .75, 1);
            l.src = e
        }
    }
...
function iconTest() {
    ...
    for (let s in shapes) {
        ...
        p.onload = function() {
            ...
            a.font = "10px Arial",
            a.fillStyle = "#000000",
            a.fillText(s, getSpriteX(h) * glIconSize + o + 5, getSpriteY(h) * glIconSize + n + 15)
        }
        ;
        let w = svgShapeToURI(h, "#FFFFFF", "#000000", .375, v);
        p.src = w;
        let L = svgShapeToSVG_0(h, "#FFFFFF", "#000000", .375, 1.4);
        if (i[s] = L,
        e.has("grid")) {
            let l = document.createElement("img");
            l.onload = function() {
